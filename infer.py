...
parser.add_argument('--resume', type=int, default=None, help='resume from previous training ex. --resume=100')
...
parser.add_argument('--src_font', type=str, default='./charset/cjk/edukai-4.0.ttf')
parser.add_argument('--type_file', type=str, default='./type/tw.txt')
